...
#if defined(CONFIG_600D) || defined(CONFIG_1200D)    /* Defining same DEFAULT_RAW_BUFFER for 1200D for now */
...
/* todo: figure out how much Canon code allocates for their LV RAW buffer - how? */
        ...
        defined(CONFIG_600D) || defined(CONFIG_1200D)
 ...
 */
    ...
    defined(CONFIG_1100D) || defined(CONFIG_7D) || defined(CONFIG_1200D)
